# Hyper Library
This documentation is for the stable release of Hyper Library.

## Booting the library
```lua
local HyperLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/ImNotRox1/vwareui/main/vwaresource')))()
```
